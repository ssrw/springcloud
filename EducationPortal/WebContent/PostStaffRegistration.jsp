...
<div class="wrap">
 ...
 <div class="dropdown">
  <li><span style="color:#008cc4">Portal</span></li>
  <div class="dropdown-content">
    <li><a href="DisplayStudentRecords.jsp">Student Portal</a></li>
    <li><a href="setupClassSchedule.jsp">Class Schedule Set Up</a></li>
    <li><a href="studentAttendanceUpload.jsp">Student Attendance Management</a></li>
    <li><a href="examResultUpload.jsp">Exam Result Upload</a></li>
  </div>
</div>
